...
function EngBank_hook_BagSlotButton_OnClick(self)
	EngBags_PrintDEBUG("event: BagSlotButton_OnClick(self)");
	EngBank_savedhookfunctions["BagSlotButton_OnClick"](self);
	EngBank_UpdateWindow();
end

function EngBank_hook_BagSlotButton_OnDrag(self)
	EngBank_savedhookfunctions["BagSlotButton_OnDrag"](self);
