...
function EngInventory_hook_BagSlotButton_OnClick(self)
	EngBags_PrintDEBUG("event: BagSlotButton_OnClick(self)");
	EngInventory_savedhookfunctions["BagSlotButton_OnClick"](self);
	EngInventory_UpdateWindow();
end

function EngInventory_hook_BagSlotButton_OnDrag(self)
	EngInventory_savedhookfunctions["BagSlotButton_OnDrag"](self);
	EngBags_PrintDEBUG("event: BagSlotButton_OnDrag(self)");
	EngInventory_UpdateWindow();
end
